...
create table "question" ("enquete_id" INTEGER NOT NULL,"question_id" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"question_order" INTEGER NOT NULL,"description" VARCHAR NOT NULL,"question_type" INTEGER NOT NULL);
create table "single_selection_answer" ("answerer_id" OTHER NOT NULL,"question_id" INTEGER NOT NULL,"question_option_id" INTEGER NOT NULL);
alter table "single_selection_answer" add constraint "pk_single_selection_answer" primary key("answerer_id","question_id");
...
alter table "single_selection_answer" add constraint "fk_single_selection_answer_question" foreign key("question_id") references "question"("question_id") on update NO ACTION on delete NO ACTION;
...
alter table "single_selection_answer" drop constraint "fk_single_selection_answer_question";
drop table "enquete";
drop table "question_option";
drop table "question";
alter table "single_selection_answer" drop constraint "pk_single_selection_answer";
drop table "single_selection_answer";
